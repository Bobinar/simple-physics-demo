...
void HandleMouseUp(int x, int y) { g_sceneManager->ShootSphere(x, y); }
...
int main(int argc, char* argv[])
{
	...
	window = SDL_CreateWindow("Simple Physics Demo", SDL_WINDOWPOS_UNDEFINED,
