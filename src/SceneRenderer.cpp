...
SceneRenderer::SceneRenderer(
	GLuint width, GLuint height, const Shader* pSceneShader,
	const Shader* pDepthShader, QuadMesh* pQuadMesh, SphereMesh* pSphereMesh,
	...
	: m_width(width), m_height(height), m_pSceneShader(pSceneShader),
	  m_pDepthShader(pDepthShader), m_viewMatrix(viewMatrix),
	  m_projectionMatrix(projectionMatrix),
	  m_lightSpaceViewProjectionMatrix(lightSpaceViewProjectionMatrix),
	  m_pQuadMesh(pQuadMesh), m_pSphereMesh(pSphereMesh),
